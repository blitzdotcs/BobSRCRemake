...
class Character extends FNFSprite
{
	...
	public function setCharacter(x:Float, y:Float, character:String):Character
	{
		...
		switch (curCharacter)
		{
			...
			// Bob bob bob bob bo bob bob bob bob bob bo bob bob bob bo bob bob bob bob bo bob
			case 'ron-littleman':
				tex = Paths.getSparrowAtlas('characters/halloween/gf-moonrise');
				frames = tex;
				animation.addByPrefix('idle', 'ron little man boppin', 24, false);
				animation.addByPrefix('sad', 'ron little man missed', 24);
				playAnim('idle');

			case 'bob-halloween':
				tex = Paths.getSparrowAtlas('characters/halloween/bob');
				frames = tex;
			...
			case 'ron-halloween':
				tex = Paths.getSparrowAtlas('characters/halloween/ron');
				frames = tex;
				animation.addByPrefix('idle', 'ronidle', 24, false);
				animation.addByPrefix('idle-alt', 'RON_mischievous_idle', 24, false);
				...
				animation.addByPrefix('dead', 'ron_dead', 24);
				flipX = true;
				playAnim('idle');

			case 'little-man-halloween':
				tex = Paths.getSparrowAtlas('characters/halloween/little-man');
				frames = tex;
