	...
	**/
	public static var gameWeeks:Array<Dynamic> = [
		[
			...
			['bob-halloween', 'ron-halloween', 'little-man-halloween'],
			[FlxColor.fromRGB(129, 100, 223)],
			'Hes spoooooky now
			oooooooooooooooooooooooooooooh oooooooooooooooooooooooooh spooky'
		],
		[
			['No Song here'],
			['bf'],
			[FlxColor.fromRGB(129, 100, 223)],
			'Source remade by Blitzdotcs!!'
		],
	];
	...
	function onCrash(e:UncaughtErrorEvent):Void
	{
		...
		errMsg += "\nUncaught Error: " + e.error + "\nPlease report this error to the GitHub page: https://github.com/Blitzdotcs/BobSRCRemake";
